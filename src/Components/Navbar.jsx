    ...
    <Navbar bg="white" expand="lg" className='position-absolute top-0 w-100 start-0' style={{height:'64px'}}>
      <Container className='pt-1 pb-2'>
        ...
        <Navbar.Collapse id="basic-navbar-nav" className="nav-collapse pt-md-5 pt-lg-0 ">
          ...
          <Nav>
            <NavDropdown title={<span className="d-flex flex-column align-items-center" id='business'><i className="bi bi-grid-3x3-gap-fill"></i>Per le aziende</span>} id="nav-dropdown-business" className="d-flex flex-column align-items-center">
